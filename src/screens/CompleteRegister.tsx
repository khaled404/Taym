...
import {InputEditIcon} from "../../assets/Icons/Icons";
        ...
        <Container style={styles.container}>
            ...
            <Content noPadding style={styles.contentContainer}>
                <View style={styles.sectionTitleContainer}>
                    ...
                    <Text style={styles.sectionTitle}>{t('To Complete Your Registeration')}</Text>
                </View>
                    ...
                    <View style={styles.submitContainer}>
                        <Touchable>
                            <View style={styles.buttonContent}>
                                <Text style={styles.submitTitle}>{t('Get OTP')}</Text>
                            </View>
                        </Touchable>
                    </View>
