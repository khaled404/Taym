...
const SocialLogin: FC<ISocialLogin> = ({title}) => {
  ...
  useEffect(() => {
    ...
    GoogleSignin.configure({
      ...
      webClientId:
        '852191488074-0v8t13du112lfr9bt13bhkd2vq8g9bnf.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
